...
import { flex, SearchBar, P, blueButton } from "./../../utilites/index";
...
class QuestionCreator extends Component {
  ...
  grabRelated = value => {
    ...
    let object = stringSimilarity.findBestMatch(
      value.target.value,
      this.state.tagNames
    );
    console.log(object);
                ...
                <Suggestions>
                  {this.state.tagsForMapping.map(e => {
                    return (
                      ...
                      >
                        <TinyTag subject={e.target} x={true} />
                      </TinyTagHolder>
                    );
                  })}
                </Suggestions>
